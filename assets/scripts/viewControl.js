...
ViewControl.prototype.onCancelForm = function () {
  this.beep()
  this.onSplashScreenView()
}

// ViewControl.onSignUpView()
//    sets the html content of the content-state component to the sign up form

ViewControl.prototype.onSignUpView = function () {
  this.beep()
  this.messageView.clear()
...
// ViewControl.onChangePasswordView()
//    sets the html content of the content-state component to the
//    change password form

ViewControl.prototype.onChangePasswordView = function (event) {
...
// ViewControl.onPlayGameView()
//    sets the html content of the content-state component
//    to the play game view

ViewControl.prototype.onPlayGameView = function () {
  this.beep()
